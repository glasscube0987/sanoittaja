...
const en = {
  ...
  'editor.textSmaller': 'Smaller lyrics',
  'editor.textLarger': 'Larger lyrics',
  ...
  'draw.eraser': 'Erase',
  'draw.text': 'Text',
  'draw.undo': 'Undo annotation',
  'draw.penSize': 'Pen size {size}',
  'draw.eraserSize': 'Eraser size {size}',
  'draw.textSize': 'Text size {size}',
  'draw.finger': 'Finger draws',
  'draw.fingerShort': 'Finger',
  'text.hint': 'Tap the sheet to add a note',
  ...
  'line.actions': 'Row',
  'line.addBelow': 'Add line below',
  'line.duplicate': 'Duplicate line',
  'line.copy': 'Copy line',
  'line.pasteBelow': 'Paste line below',
...
const fi: Record<Key, string> = {
  ...
  'editor.textSmaller': 'Pienempi sanoitus',
  'editor.textLarger': 'Suurempi sanoitus',
  ...
  'draw.eraser': 'Pyyhi',
  'draw.text': 'Teksti',
  'draw.undo': 'Kumoa merkintä',
  'draw.penSize': 'Kynän koko {size}',
  'draw.eraserSize': 'Pyyhkimen koko {size}',
  'draw.textSize': 'Tekstin koko {size}',
  'draw.finger': 'Sormi piirtää',
  'draw.fingerShort': 'Sormi',
  'text.hint': 'Napauta lehteä lisätäksesi merkinnän',
  'text.placeholder': 'Merkintä',
  'text.font': 'Kirjasin: {name}',
  'text.fontSans': 'Pääteviivaton',
  'text.fontMono': 'Tasalevyinen',
  'text.fontSerif': 'Antiikva',
  'text.bold': 'Lihavointi',
  'text.italic': 'Kursivointi',
  'text.boxed': 'Peittävä tausta',
  'text.delete': 'Poista teksti',
  ...
  'line.actions': 'Rivi',
  'line.addBelow': 'Lisää rivi alle',
  'line.duplicate': 'Monista rivi',
  'line.copy': 'Kopioi rivi',
  'line.pasteBelow': 'Liitä rivi alle',
